...
| 门楼（架空） | `gatehouse-3d/` | 体素风格虚构门楼解构（2026-08-29 两次更名定稿：西秦会馆→盐署门楼→门楼 The Gatehouse，回归门本身；原型资料降为内部研究档案） | `gatehouse-3d/docs/00-progress.md`（唯一进度源：每轮只做一个任务，收尾前必须回写状态行） |
