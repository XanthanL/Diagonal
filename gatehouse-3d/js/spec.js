...
export const C = {
  tile:      0x577f91,  // 黛青瓦(挂瓦垄贴图后整体会压暗,故再抬一档)
  tileDeep:  0x44626f,  // 瓦檐口暗端
  ridge:     0x6d94a4,  // 垂脊/围脊亮一线
...
export const ENV = {
  ...
  mist: { count: 9 },
  fireflies: { count: 70 },
  // 日轮:必须落在 WORLD.sun.pos 这条主光射线上(否则「光从右上来、日轮却挂左边」,画家一眼看穿)
  sun: { pos: [180, 156, 102], r: 7 },
};
