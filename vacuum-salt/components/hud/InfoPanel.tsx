            ...
            <div className="px-4 py-4 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-2 text-xs flex-wrap">
                  <span className="px-2 py-1 rounded bg-paper-200 text-ink-700">
                    {lang === "zh" ? stage.input : stage.inputEn}
                  </span>
                  <span className="text-diagonal-red">→</span>
                  <span className="px-2 py-1 rounded bg-paper-200 text-ink-700 border border-black/10">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  {(lang === "zh" ? stage.principle : stage.principleEn).map((p, i) => (
        ...
        >
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="accent-line pl-3">
                ...
                <h2 className="text-xl md:text-2xl font-serif font-bold text-ink-900">
                  {lang === "zh" ? zigongGeology.title : zigongGeology.titleEn}
                </h2>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="space-y-3">
              {(lang === "zh" ? zigongGeology.paragraphs : zigongGeology.paragraphsEn).map((p, i) => (
            ...
            <div className="mt-5 pt-4 border-t border-black/10">
              ...
              <ul className="space-y-1">
                {(lang === "zh" ? zigongGeology.refs : zigongGeology.refsEn).map((r, i) => (
