 ...
 * 文字全部走 HUD，这里只保留最小化的方位编号。
 */
export function StageMarker({ x, index, active = false, tint = metalColors.alloy }: StageMarkerProps) {
        ...
        <div
          className={`flex items-center justify-center w-7 h-7 rounded-full font-mono text-[11px] select-none transition-colors ${
            active
              ...
              : "bg-white/85 text-ink-600 border border-line-med"
          }`}
        >
          {num}
        </div>
