...
export const archiveData: ArchiveItem[] = [
  {
    ...
    titleEn: "The Art of Travel Salon Sharing | Travel, Life and Art Series No.1",
    artist: "对角线计划",
    artistEn: "Diagonal",
    year: "2026.07.07 12:26",
    type: "Document",
    typeEn: "Document",
    tags: ["沙龙分享", "旅行的艺术", "对角线漫谈", "自贡"],
    tagsEn: ["Salon", "The Art of Travel", "Diagonal Talk", "Zigong"],
    location: { city: "自贡", cityEn: "Zigong", code: "ZG", coordinates: "29.3N, 104.7E" },
    region: "Southwest",
    thumbnail: "/images/archive/DIAGONAL-2026-TA1/cover.jpg",
  },
  {
    id: "DIAGONAL-2026-FH1",
    title: "分享会回顾｜“生命之盐”自贡盐文化当代艺术展分享会在自贡市图书馆举行",
    titleEn: "Sharing Session Review | The Salt of Life Sharing Session at Zigong Library",
    artist: "对角线计划 / 彭玮雯 Vivienne Peng / 孙晓鸣 Kerribin",
    artistEn: "Diagonal / Vivienne Peng / Kerribin",
    year: "2026.07.04 18:49",
    type: "Document",
    typeEn: "Document",
    tags: ["分享会回顾", "自贡市图书馆", "驻留创作", "学术观察", "地方文化"],
    tagsEn: ["Sharing Session Review", "Zigong Library", "Residency", "Academic Observation", "Local Culture"],
    location: { city: "自贡", cityEn: "Zigong", code: "ZG", coordinates: "29.3N, 104.7E" },
    region: "Southwest",
    thumbnail: "/images/archive/DIAGONAL-2026-FH1/cover.jpg",
  },
  {
    id: "DIAGONAL-2026-OD1",
    title: "开幕日回顾｜“生命之盐”自贡盐文化当代艺术展在自流井老街开幕",
    titleEn: "Opening Day Review | The Salt of Life Contemporary Art Exhibition Opens at Ziliujing Old Street",
    artist: "对角线计划 / 参展艺术家",
    artistEn: "Diagonal / Participating Artists",
    year: "2026.07.01 20:22",
    type: "Document",
    typeEn: "Document",
    tags: ["开幕回顾", "当代艺术展", "自贡", "生命之盐", "自流井老街"],
    tagsEn: ["Opening Review", "Contemporary Art", "Zigong", "The Salt of Life", "Ziliujing Old Street"],
    location: { city: "自贡", cityEn: "Zigong", code: "ZG", coordinates: "29.3N, 104.7E" },
    region: "Southwest",
    thumbnail: "/images/archive/DIAGONAL-2026-OD1/cover.jpg",
  },
  {
    id: "DIAGONAL-2026-ZH1",
    title: "活动预告｜追痕在自贡——“生命之盐”自贡盐文化当代艺术展系列活动",
    titleEn: "Event Preview | Traces in Zigong: The Salt of Life Exhibition Series",
    artist: "对角线计划 / 倪卫华",
    artistEn: "Diagonal / Ni Weihua",
    year: "2026.06.29 15:51",
    type: "Performance",
    typeEn: "Performance",
    tags: ["活动预告", "追痕在自贡", "社会参与式艺术", "倪卫华", "自流井老街"],
    tagsEn: ["Event Preview", "Traces in Zigong", "Socially Engaged Art", "Ni Weihua", "Ziliujing Old Street"],
    location: { city: "自贡", cityEn: "Zigong", code: "ZG", coordinates: "29.3N, 104.7E" },
    region: "Southwest",
    thumbnail: "/images/archive/DIAGONAL-2026-ZH1/cover.jpg",
  },
  {
    id: "DIAGONAL-2026-OP1",
    title: "开幕式&分享会介绍｜“生命之盐”自贡盐文化当代艺术展",
    titleEn: "Opening & Sharing Session Introduction | The Salt of Life: Contemporary Art Exhibition on Zigong Salt Culture",
    artist: "对角线计划",
    artistEn: "Diagonal",
    year: "2026.06.26 22:33",
    type: "Document",
    typeEn: "Document",
    tags: ["开幕式", "分享会", "展览介绍", "自贡", "生命之盐"],
    tagsEn: ["Opening Ceremony", "Sharing Session", "Exhibition Introduction", "Zigong", "The Salt of Life"],
    location: { city: "自贡", cityEn: "Zigong", code: "ZG", coordinates: "29.3N, 104.7E" },
    region: "Southwest",
    thumbnail: "/images/archive/DIAGONAL-2026-OP1/cover.jpg",
  },
  {
    id: "DIAGONAL-2026-CT1",
    title: "策展团队介绍｜“生命之盐”自贡盐文化当代艺术展",
    titleEn: "Curatorial Team Introduction | The Salt of Life: Contemporary Art Exhibition on Zigong Salt Culture",
    artist: "对角线计划",
    artistEn: "Diagonal",
    year: "2026.06.23 21:49",
    type: "Document",
    typeEn: "Document",
    tags: ["策展团队", "展览介绍", "自贡", "生命之盐"],
    tagsEn: ["Curatorial Team", "Exhibition Introduction", "Zigong", "The Salt of Life"],
    location: { city: "自贡", cityEn: "Zigong", code: "ZG", coordinates: "29.3N, 104.7E" },
    region: "Southwest",
    thumbnail: "/images/archive/DIAGONAL-2026-CT1/cover.jpg",
  },
  {
    id: "DIAGONAL-2026-AC1",
    title: "学术观察员&合作方等介绍｜“生命之盐”自贡盐文化当代艺术展",
    titleEn: "Academic Observers & Partners Introduction | The Salt of Life: Contemporary Art Exhibition on Zigong Salt Culture",
    artist: "对角线计划",
    artistEn: "Diagonal",
    year: "2026.06.22 18:16",
    type: "Document",
    typeEn: "Document",
    tags: ["学术观察员", "合作方", "展览介绍", "自贡", "生命之盐"],
    tagsEn: ["Academic Observers", "Partners", "Exhibition Introduction", "Zigong", "The Salt of Life"],
    location: { city: "自贡", cityEn: "Zigong", code: "ZG", coordinates: "29.3N, 104.7E" },
    region: "Southwest",
    thumbnail: "/images/archive/DIAGONAL-2026-AC1/cover.jpg",
  },
  {
    id: "DIAGONAL-2026-VT1",
    title: "志愿者与实习生招募｜“生命之盐”自贡盐文化当代艺术展",
    titleEn: "Volunteers & Interns Recruitment | The Salt of Life: Contemporary Art Exhibition on Zigong Salt Culture",
    artist: "对角线计划",
    artistEn: "Diagonal",
    year: "2026.06.22 18:16",
    type: "Document",
    typeEn: "Document",
    tags: ["招募", "志愿者", "实习生", "自贡", "生命之盐"],
